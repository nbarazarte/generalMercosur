-- Archivo convertido de MySQL a PostgreSQL
-- Conversión automática: removidos SETs, AUTO_INCREMENT -> serial,
-- int(11) -> integer, tinyint(1) -> smallint, iso_3166-2 -> iso_3166_2
...
CREATE INDEX idx_ciudades_id_estado ON ciudades (id_estado);
...
INSERT INTO estados (id_estado, pais_id, estado, iso_3166_2) VALUES
(1, 35,'Amazonas', 'VE-X'),
(2, 35,'Anzoátegui', 'VE-B'),
(3, 35,'Amazonas', 'VE-X'),
(2, 35,'Anzoátegui', 'VE-B'),
(3, 35,'Apure', 'VE-C'),
(4, 35,'Aragua', 'VE-D'),
...
(14, 35,'Miranda', 'VE-M'),
(15, 35,'Monagas', 'VE-N'),
(16, 35,'Nueva Esparta', 'VE-O'),
(17, 35,'Portuguesa', 'VE-P'),
(18, 35,'Sucre', 'VE-R'),
(19, 35,'Táchira', 'VE-S'),
(20, 35,'Trujillo', 'VE-T'),
(21, 35,'Vargas', 'VE-W'),
(22, 35,'Yaracuy', 'VE-U'),
(23, 35,'Zulia', 'VE-V'),
(24, 35,'Distrito Capital', 'VE-A'),
(25, 35,'Dependencias Federales', 'VE-Z');
...
CREATE INDEX idx_municipios_id_estado ON municipios (id_estado);
...
CREATE INDEX idx_parroquias_id_municipio ON parroquias (id_municipio);
