...
const styles = StyleSheet.create({
  ...
  logo: { width: 80, height: "auto", marginRight: 15 },
  headerText: { flex: 1 },
  title: {
    fontSize: 13,
    fontWeight: "bold",
...
const FormatoFicha = ({ datos }) => {
  const s = (v) => {
    if (!v || String(v).trim() === "" || v === false) return "SIN DATOS";
  ...
  const v = (val) => (val ? String(val).toUpperCase() : "SIN DATOS");
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* SECCIÓN 2: DATOS DEL CONYUGUE */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>2. DATOS DEL CONYUGUE</Text>
        ...
        <View style={{ marginTop: 400, marginBottom: 0 }} wrap={false}>
          <View
            style={{
              //flexDirection: "row",
              //justifyContent: "space-between",
            ...
            <View style={{ width: "100%", alignItems: "center" }}>
              ...
              <View
                style={{
                  ...
                  width: "100%",
                  paddingTop: 3,
                  alignItems: "center", // Mantiene el contenido centrado respecto a la línea
                }}
              >
                {/* Contenedor horizontal para los datos */}
                <View style={{ flexDirection: "row", gap: 10, marginTop: 2 }}>
                  <Text style={styles.label}>FIRMA DEL INVERSIONISTA</Text>
                  <Text style={{ fontSize: 10 }}>C.I.: {v(datos.cedula)}</Text>
